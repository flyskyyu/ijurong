...
public class JpushClientUtil {
    ...
    private final static String appKey = "4b3169800e9b9fd4faea9ad0";

    private final static String masterSecret = "27dc33cc45a912b04acd433e";
    ...
    public static void main(String[] args){
        if(JpushClientUtil.sendToAllAndroid("yuqin","yuqin","this is a ios Dev test","")==1){
