...
<head>
    ...
    <script type="text/javascript">
        ...
        function formatOperation(value, rowData, rowIndex) {
            var result = "";
            <shiro:hasPermission name="examQuestion:update">
...
<div region="center" style="padding: 5px;">
    <div id="examQuestion_toolbar" style="padding: 5px; height: auto">
        <div style="padding: 5px;">
            ...
            <shiro:hasPermission name="examQuestion:query">
    ...
    <table id="examQuestion_grid"
           ...
           url="findExamQuestions" toolbar="#tb" rownumbers="true" pageSize="20" style="width:auto;"
           singleSelect="true">
        <thead>
        <tr>
                ...
                <div title="" data-options="closable:false"
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><input type="text" name="questionContent"
                            ...
                            <td class="kv-content" colspan="3">
                                <div>
                                    ...
                                    <div style="text-align:right; margin-right: 10px; margin-top: 10px;">
                                        <img style="width:30px;height: 30px;" id="addAnswer" src="/img/add_img_icon.png"
                                             alt="">
                                    </div>
