...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $('#addAnswer').bind('click', function() {
                var html_answer='<tr><td class="kv-content"><input type="text" name="optionContent"/></td>'+
                        '<td class="kv-content"><input type="radio" name="isCorrect" value="1"/>是<input type="radio" name="isCorrect" value="0"/>否</td>'+
        ...
        function postData()
        {
            var length=document.getElementById("tab_answer").rows.lengt;
            var jsonArray = [];
            for(var i=1;i<length;i++)
            {
                var json = new Object;
                var a=document.getElementById("tab_answer").rows[i].cells[0].firstChild.value;
                var b=$(document.getElementById("tab_answer").rows[i].cells[1]).find('input:checked').val()
                var c=document.getElementById("tab_answer").rows[i].cells[2].firstChild.value;
                json.optionContent=a;
                json.isCorrect=b;
                json.optionNum=c;
                jsonArray.push(json);
            }
        ...
        $(function() {
            $('#btn_remove').bind('click', function() {
                ...
                var url = 'delectExamQuestion/' + rowData.id;
...
<div region="center" style="padding: 5px;">
    ...
    <table id="examQuestion_grid"
        ...
        <tr>
            ...
            <th data-options="field:'name',align:'center'" width="30">题目名称</th>
                ...
                <div title="" data-options="closable:false"
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><textarea name="explain" rows="5"></textarea></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
