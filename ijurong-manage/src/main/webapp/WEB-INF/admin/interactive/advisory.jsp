...
<head>
    ...
    <script type="text/javascript">
        ...
        function formatOperation(value, rowData, rowIndex) {
            var result = "";
            <shiro:hasPermission name="advisory:update">
        ...
        function formatType(value, rowData, rowIndex) {
            var result = "";
            result = '<a style="color:green;text-decoration:none;">互动咨询</a>';
            return result;
        }
...
<div region="center" style="padding: 5px;">
    <div id="panelDiscussion_toolbar" style="padding: 5px; height: auto">
        <div style="padding: 5px;">
            ...
            <shiro:hasPermission name="advisory:query">
                <a href="#" class="easyui-linkbutton" id="btn_Search"
                   data-options="iconCls:'icon-search'" onclick="doSearch()">查找</a>&nbsp;
            </shiro:hasPermission>
            <%--<shiro:hasPermission name="panelDiscussion:add">--%>
            <%--<a href="#" class="easyui-linkbutton"--%>
            <%--data-options="iconCls:'icon-add'" id="btn_add">添加</a>&nbsp;--%>
            <%--</shiro:hasPermission>--%>
            <shiro:hasPermission name="advisory:delete">
    ...
    <table id="panelDiscussion_grid"
           ...
           url="findAdvisorys" toolbar="#tb" rownumbers="true" pageSize="20" style="width:auto;"
           singleSelect="true">
        <thead>
        <tr>
            ...
            <div class="content">
                <div title="" data-options="closable:false"
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><select name="isShadow" class="easyui-combobox">
                                <option value="2" selected>互动咨询</option>
                            </select></td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="kv-table">
                        <tbody>
                        <tr>
                            <td class="kv-label">发表回复</td>
                            <td class="kv-content" colspan="3"><textarea name="adminReply" rows="5"></textarea></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
