...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit() {
            if ($("#appSkinsVersion_form").form('validate')) {
                $.ajax({
                    url: appSkinsVersion_form.action,
                    type: appSkinsVersion_form.method,
                    data: $(appSkinsVersion_form).serialize(),
        ...
        $(function () {
            $('#btn_add').bind('click', function () {
                ...
                TT.resetForm('appSkinsVersion_dialog');
        ...
        function formatOperation(value, rowData, rowIndex) {
            var result = "";
            <shiro:hasPermission name="appSkinVersion:update">
...
<div region="center" style="padding: 5px;">
    <div id="appSkinsVersion_toolbar" style="padding: 5px; height: auto">
        <div style="padding: 5px;">
            ...
            <shiro:hasPermission name="appSkinVersion:query">
            <a href="#" class="easyui-linkbutton" id="btn_Search"
               data-options="iconCls:'icon-search'" onclick="doSearch()">查找</a>&nbsp;
            </shiro:hasPermission>
            <shiro:hasPermission name="appSkinVersion:add">
            <a href="#" class="easyui-linkbutton"
               data-options="iconCls:'icon-add'" id="btn_add">添加</a>&nbsp;
            </shiro:hasPermission>
            <shiro:hasPermission name="appSkinVersion:delete">
    ...
    <table id="appSkinsVersion_grid"
           ...
           url="findAppSkinVersions" toolbar="#tb" rownumbers="true" pageSize="20" style="width:auto;"
           singleSelect="true">
        <thead>
        <tr>
                ...
                <div title="" data-options="closable:false"
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><input class="easyui-datetimebox" name="startTime"
                                                                      data-options="required:true"/></td>
                        </tr>
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><select id="refGrid1" class="easyui-combogrid"
                                                                       style="width: 230px"
                                                                       data-options="mode:'remote',required:true,
							panelWidth: 350,
							loadMsg: '正在搜索，请稍等...',
							pagination : true,
							idField: 'id',
