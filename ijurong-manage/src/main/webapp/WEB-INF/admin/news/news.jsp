...
<div region="center" style="padding: 5px;">
    <div id="news_toolbar" style="padding: 5px; height: auto">
        <div style="padding: 5px;">
            ...
            <shiro:hasPermission name="news:query">
                ...
                <div title="" data-options="closable:false"
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><input type="text" name="subtitle"
                                                                      class="easyui-validatebox"
                                                                      data-options="required:true"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><input type="text" name="origin"
                                                                      class="easyui-validatebox"
                                                                      data-options="required:true"/></td>
                        </tr>
                        <tr>
                            ...
                            <td class="kv-content" colspan="3"><input type="file" name="file"><br/>
                                <img src="#" alt="已上传图片" id="img_uploaded_url" style="width: 72px;height: 72px;"></td>
