...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit() {
            if ($("#newsSpecial_form").form('validate')) {
                $.ajax({
        ...
        function formatOperation(value, rowData, rowIndex) {
            var result = "";
            <shiro:hasPermission name="special:update">
...
<div region="center" style="padding: 5px;">
    <div id="newsSpecial_toolbar" style="padding: 5px; height: auto">
        <div style="padding: 5px;">
            ...
            <shiro:hasPermission name="special:query">
                <a href="#" class="easyui-linkbutton" id="btn_Search"
                   data-options="iconCls:'icon-search'" onclick="doSearch()">查找</a>&nbsp;
            </shiro:hasPermission>
            <shiro:hasPermission name="special:add">
                <a href="#" class="easyui-linkbutton"
                   data-options="iconCls:'icon-add'" id="btn_add">添加</a>&nbsp;
            </shiro:hasPermission>
            <shiro:hasPermission name="special:delete">
